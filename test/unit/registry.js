...
describe('Registry', function() {
  ...
  describe('find()', function() {
    it('exact', function() {
      ...
      expect(TestRegistry.find(blockNode.querySelector('span'))).toBe(blockBlot.children.head);
      expect(TestRegistry.find(blockNode.querySelector('em'))).toBe(blockBlot.children.tail);
