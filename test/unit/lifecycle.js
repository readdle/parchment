...
describe('Lifecycle', function() {
  ...
  describe('optimize()', function() {
    it('unwrap empty inline', function() {
      ...
      node.innerHTML = '<span style="color: red;"><strong>Te</strong><em>st</em></span>';
      ...
      expect(this.container.innerHTML).toEqual('<p><strong>Te</strong><em>st</em></p>');
    });
    ...
    it('format recursive merge', function() {
      ...
      this.scroll.optimize();
      expect(this.container.innerHTML).toEqual('<p><em><strong>Test</strong></em></p>');
      expect(this.container.querySelector('strong').childNodes.length).toBe(1);
    });
  ...
  describe('update()', function() {
    ...
    describe('dom', function() {
      ...
      it('add empty family', function() {
        ...
        expect(this.scroll.descendants(ShadowBlot).length).toEqual(this.descendants.length);
      });
      ...
      it('wrap text', function() {
        ...
        this.scroll.domNode.appendChild(spanNode);
      ...
      it('text changes with incorrect mutation', function() {
        ...
        this.scroll.update([mutationRecord]);
        this.checkUpdateCalls(attrBlot);
        this.checkValues(['Test', '|', { image: true }, 'ing', '!']);
      });
    });
